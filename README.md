...
| MODE                     | The mode this container will run in, with the supported options of `extract` or `deploy`                      | Optional if the mode is not passed in as a service parameter to the Docker container                                            |
