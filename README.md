...
| OAUTH2_TOKEN_URL         | The authentication endpoint URL for retrieving the OAUTH token                                                  | Required for Self managed web modeler operations                                                                                |
| OAUTH_PLATFORM           | The OAUTH platform in use                                                                                       | Optional (default = KEYCLOAK, supported values: KEYCLOAK, ENTRA)                                                                |
